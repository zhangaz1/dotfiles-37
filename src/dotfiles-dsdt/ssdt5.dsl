 ...
 *
 * Disassembly of ssdt5.dat, Wed Mar 11 20:25:19 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "Tpm2Tabl", 0x00001000)
{
    Scope (\_SB)
    {
        Device (TPM)
        {
            ...
            OperationRegion (TNVS, SystemMemory, 0x4FB45000, 0x2F)
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                Else
                {
                    CreateDWordField (RES0, \_SB.TPM._Y3D._INT, LIRQ)  // _INT: Interrupts
            ...
            Method (_SRS, 1, Serialized)  // _SRS: Set Resource Settings
            {
                ...
                CreateBitField (RES0, \_SB.TPM._Y3D._HE, LTRG)  // _HE_: High-Edge
                LTRG = ITRG /* \_SB_.TPM_._SRS.ITRG */
                CreateBitField (Arg0, 0x7A, ILVL)
                CreateBitField (RES0, \_SB.TPM._Y3D._LL, LLVL)  // _LL_: Low Level
